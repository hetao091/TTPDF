...
public class DocumentActivity extends Activity
{
	...
	private TTVerticalSeekBar      mPageSlider;
	...
	private void makeButtonsView() {
		...
		mPageSlider = (TTVerticalSeekBar)mButtonsView.findViewById(R.id.pageSlider);
		...
		mImageViewBack = (ImageView) mButtonsView.findViewById(R.id.iv_back);
